...
# git worktree add checks out HEAD: the ledger, work orders, and generated
# harness config the architect just wrote may be uncommitted and would be
# missing here — leaving the loop orderless and loop-guard toothless. Copy
# them in on every iteration so mid-run additions (a work order written
...
`
    : "";
  const isolateSync = loop.isolate ? "  sync_worktree_assets\n" : "";
